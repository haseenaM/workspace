...
public class Customers {
	...
	/**
	 * @return the customer_middlename
	 */
	public String getCustomer_middlename() {
		return customer_middlename;
	}
	/**
	 * @param customer_middlename the customer_middlename to set
	 */
	...
	/**
	 * @return the customer_phno
	 */
	public String getCustomer_phno() {
		return customer_phno;
	}
	/**
	 * @param customer_phno the customer_phno to set
	 */
